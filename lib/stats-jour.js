...
// Compte, à la sortie, le patient comme "activité médicale" sur le créneau
// médecin (07-13/13-19/19-07) durant lequel il a été DÉCHARGÉ, s'il a eu au
// moins une prescription à la fois demandée et réalisée (marquée faite) au
// cours du séjour. Sert uniquement à visualiser l'activité (vue réservée,
// pas de seuil ni de lissage automatique dessus).
export async function incrementerActiviteMedicaleJour(patient) {
  try {
