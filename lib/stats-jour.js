...
import { jourLocal, heureLocale, jourMoinsNJours, jourPlusNJours, BORNES_CRENEAU_MEDECIN, CRENEAUX_MEDECIN } from './creneau';
...
// Résumé d'un créneau médecin pour un jour de service, avec repli automatique
// sur le même créneau 7 jours avant si aucun patient n'a été enregistré
// (cas d'un médecin qui n'utilise pas le logiciel sur son créneau — plutôt
// que d'afficher un 0 trompeur, on estime à partir de la semaine précédente).
