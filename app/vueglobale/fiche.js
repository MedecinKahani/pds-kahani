...
function TheraSection({prescriptions, onAjouter}) {
  ...
  const VOIES = {
    adulte: [
      ...
      {voie:'IM', label:'Voie IM', color:'#6b7280', items:['Kétoprofène 100mg IM','Ceftriaxone 1g IM','Ceftriaxone 2g IM','Adrénaline 0.5mg IM','Adrénaline 1mg IM']},
    ...
    pediatrie: [
      ...
      {voie:'IM', label:'Voie IM', color:'#6b7280', items:['Ceftriaxone 50mg/kg IM','Adrénaline 0.01mg/kg IM']},
