...
function TheraSection({prescriptions, onAjouter, onAjouterPlusieurs, patient}) {
  ...
  const FREQUENTS_ADULTE = [
    ...
    {label:'Artéméther-Luméfantrine PO (Coartem)', voie:'PO', color:'#16a34a', cat:'Anti-infectieux'},
    ...
    {label:'Amikacine 15mg/kg IV (Amiklin)', voie:'IV', color:'#2563eb', cat:'Anti-infectieux'},
    {label:'Amoxicilline 1g IV', voie:'IV', color:'#2563eb', cat:'Anti-infectieux'},
    {label:'Amoxicilline/Ac. clavulanique 1g IV (Augmentin)', voie:'IV', color:'#2563eb', cat:'Anti-infectieux'},
    {label:'Ceftriaxone 1g IV', voie:'IV', color:'#2563eb', cat:'Anti-infectieux'},
    {label:'Diazépam 10mg IV (Valium)', voie:'IV', color:'#2563eb', cat:'Neuro-sédation'},
    {label:'Kétoprofène 100mg IV (Profenid)', voie:'IV', color:'#2563eb', cat:'Antalgique'},
    {label:'Métoclopramide 10mg IV (Primpéran)', voie:'IV', color:'#2563eb', cat:'Digestif'},
    {label:'Néfopam 20mg IV (Acupan)', voie:'IV', color:'#2563eb', cat:'Antalgique'},
    {label:'Pantoprazole 40mg IV', voie:'IV', color:'#2563eb', cat:'Digestif'},
  ...
  const FREQUENTS_PEDIATRIE = [
    ...
    {label:'Artéméther-Luméfantrine selon poids PO (Coartem)', voie:'PO', color:'#16a34a', cat:'Anti-infectieux'},
  ...
  const VOIES = {
    adulte: [
      ...
      {voie:'IV', label:'Voie IV', color:'#2563eb', items:[
        ...
        '__CAT__Anti-infectieux',
        'Amikacine 15mg/kg IV (Amiklin)', 'Amoxicilline 500mg IV', 'Amoxicilline 1g IV', 'Amoxicilline 2g IV', 'Amoxicilline/Ac. clavulanique 500mg IV (Augmentin)',
        ...
        '__CAT__Digestif',
        'Métoclopramide 10mg IV (Primpéran)', 'Pantoprazole 40mg IV',
        '__CAT__Allergologie / Corticoïdes',
    ...
    pediatrie: [
      ...
      {voie:'IM', label:'Voie IM', color:'#6b7280', items:[
        '__CAT__Anti-infectieux',
        'Ceftriaxone 50mg/kg IM (Rocéphine)',
        '__CAT__Neuro-sédation',
