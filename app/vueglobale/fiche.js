  ...
  const VOIES = {
    adulte: [
      {voie:'PO', label:'Voie orale', color:'#16a34a', items:[
        'Acétylleucine 500mg PO (Tanganil)', 'Acétylsalicylate de lysine 75mg PO (Kardegic)',
        'Acide acétylsalicylique 500mg PO (Aspégic)', 'Albendazole 4% PO (Zentel)', 'Amlodipine 5mg PO (Amlor)',
        'Amoxicilline 1g PO', 'Artéméther-Luméfantrine PO (Coartem)', 'Augmentin 1g PO',
        'Azithromycine 250mg PO (Zithromax)', 'Cefixime 40mg/5ml PO', 'Cétirizine 10mg PO', 'Charbon activé PO',
        'Clobazam 5mg PO (Urbanyl)', 'Clonazépam 1mg PO (Rivotril)', 'Clopidogrel 75mg PO',
        'Dexchlorphéniramine PO (Polaramine)', 'Doxycycline 100mg PO', 'Furosémide 40mg PO (Lasilix)',
        'Furosémide 20mg PO (Lasilix)', 'Gaviscon 1 sachet PO', 'Halopéridol 5mg PO', 'Hydroxyzine 25mg PO (Atarax)',
        'Ibuprofène 200mg PO', 'Ibuprofène 400mg PO (Antarène)', 'Ivermectine PO', 'Kétoprofène 100mg PO (Profenid)',
        'Lansoprazole 15mg PO', 'Lévétiracétam 500mg/5ml PO (Keppra)', 'Lévonorgestrel 1.5mg PO', 'Loxapine 50mg PO',
        'Métoclopramide 10mg PO (Primpéran)', 'Métopimazine 7.5mg PO (Vogalène)', 'Midazolam 5mg PO (Hypnovel)',
        'Naproxène 550mg PO', 'Nicardipine 10mg PO (Loxen)', 'Nifédipine 50mg PO (Loxen LP)', 'Ofloxacine 200mg PO',
        'Oxazépam 10mg PO (Seresta)', 'Pantoprazole 40mg PO', 'Paracétamol 500mg PO', 'Paracétamol 1g PO',
        'Paracétamol codéïne 500mg PO', 'Phénobarbital 200mg PO (Gardénal)', 'Phénytoïne 250mg PO (Dilantin)',
        'Prednisolone 5mg PO (Solupred)', 'Prednisolone 20mg PO (Solupred)', 'Propranolol 10mg PO',
        'Racécadotril 100mg PO (Tiorfan)', 'Rivaroxaban 15mg PO (Xarelto)', 'Salbutamol 100mcg aérosol (Ventoline)',
        'Sels réhydratation PO (Adiaril)', 'Tramadol 50mg PO (Topalgic)', 'Tramadol 100mg PO',
        'Trinitrine 0.3mg PO (Natispray)', 'Tropatépine 10mg PO (Lépicur)',
      ]},
      {voie:'IV', label:'Voie IV', color:'#2563eb', items:[
        'Acétylleucine 500mg IV (Tanganil)', 'Acide tranexamique 500mg IV (Exacyl)', 'Adénosine 6mg IV (Krenosin)',
        'Adrénaline 1mg IV', 'Adrénaline sans sulfites 5mg IV (Longoni)', 'Amiodarone 150mg IV (Cordarone)',
        'Atropine 0.5mg IV', 'Calcium gluconate 10% IV', 'Ceftriaxone 1g IV', 'Ceftriaxone 2g IV',
        'Clonazépam 1mg IV (Rivotril)', 'Dexchlorphéniramine 5mg IV (Polaramine)', 'Diazépam 10mg IV (Valium)',
        'Digoxine 0.5mg IV', 'Énoxaparine 4000UI IV (Lovenox)', 'Étomidate 20mg IV (Lipuro)',
        'Flumazénil 0.5mg IV (Anexate)', 'Fondaparinux 2.5mg IV (Arixtra)', 'Furosémide 20mg IV (Lasilix)',
        'Furosémide 250mg IV (Lasilix spécial)', 'Glucagon 1mg IV (Glucagen)', 'Glucose 10% IV', 'Glucose 30% IV',
        'Kétamine 250mg IV', 'Kétoprofène 100mg IV (Profenid)', 'Magnésium sulfate 10% IV', 'Mannitol 20% IV',
        'Méthylprednisolone 40mg IV (Solumedrol)', 'Méthylprednisolone 500mg IV (Solumedrol)',
        'Métronidazole 500mg IV', 'Midazolam 50mg IV (Hypnovel)', 'Nalbuphine 20mg IV (Nubain)',
        'Naloxone 0.4mg IV (Narcan)', 'Néfopam 20mg IV (Acupan)', 'Nicardipine 10mg IV (Loxen)',
        'Noradrénaline 8mg IV', 'Paracétamol 1g IV (Perfalgan)', 'Paracétamol 500mg IV (Perfalgan)',
        'Phénobarbital 200mg IV (Gardénal)', 'Potassium chlorure 10% IV', 'Sodium bicarbonate 4.2% IV',
      ...
      {voie:'IM', label:'Voie IM', color:'#6b7280', items:[
        'Adrénaline 1mg IM', 'Bétaméthasone LP IM (Célestène)', 'Ceftriaxone 1g IM', 'Ceftriaxone 2g IM',
        'Clonazépam 1mg IM (Rivotril)', 'Diazépam 10mg IM rectal (Valium)', 'Halopéridol 5mg IM',
        'Halopéridol décanoate 50mg IM', 'Kétoprofène 100mg IM (Profenid)', 'Morphine 10mg IM [STP]',
        'Phénobarbital 200mg IM (Gardénal)', 'Phlorglucinol 40mg IM (Spasfon)', 'Terbutaline 0.5mg IM (Bricanyl)',
        'Triamcinolone 40mg IM (Kenacort Retard)', 'Vitamine B1 100mg IM', 'Vitamine K1 10mg IM',
      ]},
      {voie:'SC', label:'Voie SC', color:'#7c3aed', items:[
        'Adrénaline 0.5mg SC', 'Énoxaparine 4000UI SC (Lovenox)', 'Fondaparinux 2.5mg SC (Arixtra)',
        'Lidocaïne 1% SC', 'Lidocaïne 2% SC', 'Lidocaïne adrénalinée SC', 'Terbutaline 0.5mg SC (Bricanyl)',
      ...
      {voie:'RESPI', label:'Respiratoire', color:'#64748b', items:[
        '__AEROSOL__', 'Adrénaline 1mg nébulisation — laryngite enfant (1amp + 4ml NaCl 0.9%)',
    ...
    pediatrie: [
      {voie:'PO', label:'Voie orale', color:'#16a34a', items:[
        ...
        'Cefixime 40mg/5ml PO', 'Cétirizine PO', 'Dexchlorphéniramine PO', 'Ibuprofène 10mg/kg PO', 'Ivermectine PO',
        'Lévonorgestrel 1.5mg PO', 'Métoclopramide sirop PO', 'Paracétamol 15mg/kg PO', 'Paracétamol 100mg sachet PO',
        'Paracétamol 200mg sachet PO', 'Paracétamol 300mg sachet PO', 'Prednisolone 5mg PO',
        'Racécadotril 100mg PO (Tiorfan)', 'Sels réhydratation PO',
      ]},
      {voie:'IV', label:'Voie IV', color:'#2563eb', items:[
        'Acide tranexamique IV (Exacyl)', 'Adrénaline 0.01mg/kg IV', 'Calcium gluconate 10% IV',
        'Ceftriaxone 50mg/kg IV', 'Ceftriaxone 100mg/kg IV', 'Clonazépam 0.02mg/kg IV (Rivotril)',
        'Dexaméthasone 0.15mg/kg IV', 'Diazépam rectal IV (Valium)', 'Furosémide 1mg/kg IV (Lasilix)',
        'Glucose 10% IV', 'Glucose 30% IV', 'Kétamine IV', 'Magnésium sulfate IV',
        'Méthylprednisolone IV (Solumedrol)', 'Midazolam IV (Hypnovel)', 'Morphine 0.1mg/kg IV [STP]', 'NaCl 0.9% IV',
        'Paracétamol 15mg/kg IV (Perfalgan)', 'Phénobarbital IV (Gardénal)', 'Ringer Lactate IV', 'Vitamine B1 IV',
        'Vitamine K1 2mg IV (NN)',
      ]},
      {voie:'IM', label:'Voie IM', color:'#6b7280', items:[
        'Adrénaline 0.01mg/kg IM', 'Ceftriaxone 50mg/kg IM', 'Ceftriaxone 100mg/kg IM', 'Glucagon IM (Glucagen)',
        'Phénobarbital IM (Gardénal)', 'Vitamine K1 2mg IM (NN)',
      ]},
      {voie:'SC', label:'Voie SC', color:'#7c3aed', items:[
        'Adrénaline SC', 'Lidocaïne 1% SC', 'Vaccin antitétanique SC', 'Vaccin Hépatite B SC (Engerix B10)',
        'Vaccin ROR SC (Priorix)',
      ]},
      {voie:'RESPI', label:'Respiratoire', color:'#64748b', items:[
  ...
  return (
    <div style={{padding:'8px 10px'}}>
      ...
      {voieOuverte && (()=>{
        ...
        const speciaux = sousVoies.filter(v=>v.special);
        ...
        function renderItemsVoie(v) {
          return (
            <div key={v.voie}>
              {voiesAvecItems.length>1 && (
        ...
        return (
          <div style={{maxHeight:'40vh',overflowY:'auto',display:'flex',flexDirection:'column',gap:10}}>
            ...
            {favoris.length>0 && !voieListeComplete ? (
              ...
              <>
                ...
                {voiesAvecItems.map(renderItemsVoie)}
              </>
            )}
          </div>
        );
