...
export default function PageMedecin() {
      ...
      <div key={cell.id} onClick={()=>{
        ...
        {p ? (
          <div style={{padding:'4px 10px 8px'}}>
            ...
            <div style={{color:'#374151',fontSize:11,marginTop:3,fontWeight:500}}>{p.motifPrincipal}</div>
            ...
            <div style={{marginTop:4,fontSize:10,color:'#9ca3af',fontWeight:600}}>{duree(p.arrivee)}</div>
            {attente&&<div style={{position:'absolute',bottom:5,right:6,background:'#fef3c7',border:'1px solid #f59e0b',borderRadius:4,padding:'1px 5px',fontSize:9,fontWeight:700,color:'#d97706'}}>ATTEND</div>}
          </div>
        ) : (
          <div style={{padding:'4px 10px 8px',display:'flex',flexDirection:'column',justifyContent:'space-between',flex:1,minHeight:60}}>
  ...
  return (
    <div style={{minHeight:'100vh',background:'#f3f4f6',display:'flex',flexDirection:'column'}}>
      ...
      <nav style={{background:'#fff',borderBottom:'1px solid #e5e7eb',padding:'0 1.5rem',display:'flex',alignItems:'center',justifyContent:'space-between',height:60,flexShrink:0}}>
        <div style={{display:'flex',alignItems:'center',gap:12}}>
          ...
          <div>
            ...
            <div style={{fontSize:11,color:'#6b7280'}}>Medecin</div>
          </div>
        </div>
        <div style={{display:'flex',alignItems:'center',gap:16}}>
          ...
          <button onClick={()=>{sessionStorage.clear();router.push('/login');}} style={{padding:'8px 14px',borderRadius:8,background:'#f3f4f6',color:'#6b7280',fontSize:13,border:'1px solid #e5e7eb',fontWeight:500}}>Deconnexion</button>
        </div>
      </nav>
          ...
          {sel&&(
            <div style={{flex:1,background:'#fff',borderLeft:'1px solid #e5e7eb',padding:'1.5rem',overflowY:'auto'}}>
              <div style={{display:'flex',justifyContent:'space-between',alignItems:'flex-start',marginBottom:'1.25rem'}}>
                ...
                <button onClick={()=>setSel(null)} style={{width:32,height:32,borderRadius:'50%',background:'#f3f4f6',color:'#6b7280',fontSize:18,display:'flex',alignItems:'center',justifyContent:'center'}}>x</button>
              </div>
